(() => {
  const cfg = {
    key: 'cfly-rewards-we-in-here-2026-06-v15-fresh',
    max: 7,
  ...
  const gameInstruction = 'Match three matching tiles for a chance to win your reward.';
  const playInstruction = 'Press Play. Match three matching tiles for a chance to win your reward.';
  ...
  function start() {
    ...
    draw();
    updateLive('CFLY Rewards is ready.', false);
  }
